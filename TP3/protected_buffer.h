...
typedef struct {
  long                sem_impl;
  pthread_cond_t      empty,full; //declares conditions attributes for buffer structure
  pthread_mutex_t     m; //declares mutex attribute for buffer structure
  sem_t               s_m, s_empty, s_full; //semaphore attributes
